...
@activitypub_app.task()
def task_send_accept_request(follow_actor, follow_object, follow_id):
...
@activitypub_app.task()
def task_read_announce(actor, object_id):
...
@activitypub_app.task()
def task_external_video_update(video):
...
@activitypub_app.task()
def task_external_video_deletion(object_id):
